...
CREATE TABLE ProductTrades (
    ...
    GEV DECIMAL(12, 2),        -- Gross Estimated Value
...
INSERT INTO ProductTrades (
    PrimaryProductID, GEV, NMV, GIS, GOS, Area, Category, ShippingRate, ShippingCost, PoRate
) VALUES
('PROD001', 15000.00, 13000.00, 14000.00, 14500.00, 'North Region', 'Electronics', 5.50, 275.00, 12000.00),
('PROD002', 8000.00, 7500.00, 7700.00, 7900.00, 'South Region', 'Apparel', 4.00, 160.00, 7200.00),
('PROD003', 22000.00, 20000.00, 21000.00, 21500.00, 'East Region', 'Furniture', 6.00, 360.00, 19500.00),
('PROD004', 5000.00, 4600.00, 4700.00, 4900.00, 'West Region', 'Toys', 3.00, 90.00, 4400.00),
('PROD005', 12000.00, 11000.00, 11500.00, 11800.00, 'Central Region', 'Beauty', 4.50, 225.00, 10800.00);

INSERT INTO ProductTrades (PrimaryProductID, GEV, NMV, GIS, GOS, Area, Category, ShippingRate, ShippingCost, PoRate) VALUES
...
('PROD012', 15232.90, 14114.83, 13891.45, 13155.84, 'Barishal', 'Grocery', 3.72, 3.98, 13444.80),
('PROD013', 17782.42, 16599.55, 16299.34, 15673.99, 'Rajshahi', 'Motors', 4.87, 5.00, 15789.24),
...
WHERE PrimaryProductID IN ('PROD231');
